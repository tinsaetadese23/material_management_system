    ...
    RequestDispatcher ds = request.getRequestDispatcher("../ADCS");
...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <div class="content-wrapper">
    ...
    <c:forEach var="roles" items ="${userRoleLists}">
    	<c:if test = "${roles.create == 1 && roles.pageIdNameHolder == 'ASSDIS'}">
    	<c:set var="create" value="1" />
    	</c:if>
    	<c:if test = "${roles.update == 1 && roles.pageIdNameHolder == 'ASSDIS'}">
    	<c:set var="update" value="1" />
    	</c:if>
    	<c:if test = "${roles.delete == 1 && roles.pageIdNameHolder == 'ASSDIS'}">
            ...
            <div class="card  card-tabs">
              <div class="card-header custom_card_branding p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3"><h3 class="card-title">Manual Asset Disposal</h3></li>
                  <li class="nav-item">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
    					<form method="post" action = "../ADCS/tag">
    					<div id="div1" class="form-group">
    						<label for="some">Tag</label><br>
    						<input type = "hidden" name ="ds" value ="tr"/>
    				...
    				<form action ="../ADCS/dis" method = "post" >
    					<div class="from-group">
    						<label>Reason for disposal</label>
    						<input name = "tag" value="<c:out value ="${ast.tagNumber}"/>" readonly type = "hidden" class="form-control">
    					    <input value=""  type="text" name="reason" class="form-control"/>
    					  </div>
    					  <br>
    					<div id = "divsub" class="form-group">
    					<c:if test = "${create == '1'}">
    					<input onclick="checkMe();" value="Dispose"  class="btn custom_button_branding" type="submit" class="form-control" id = "assetClass" />
						</c:if>
    						</div>
    				</form>	
                  </div>
    				...
    				<form>
    					...
    					<table class="table table-bordered">
	    					...
	    					<tr>
		    					...
		    					<td><a href = "../ADCS/view?id=<c:out value ="${stc.id}"/>"><i class="far fa-eye"></i></a></td>
		    					<c:if test = "${delete == '1'}">
		    					<td><a onclick="return deleteMe()" href = "../ADCS/delete?id=<c:out value ="${stc.id}"/>"><i class="fas fa-times btn-danger"></i></a></td>
								</c:if>
	    					</tr>
	    					</c:forEach>
	    					<%}%>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
   			 <form action = "../ADCS/auth" method="POST">
   			 ...
   			 <c:if test = "${objprp.authStatus == 'UDIS' }">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <c:if test = "${objprp.authStatus == 'ADIS' }">
