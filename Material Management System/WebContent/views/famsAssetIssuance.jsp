    	...
    	<div class = "row">
		 <div class="col-12 col-sm-6">
            <div class="card card-tabs">
              ...
              <form method="POST" action = "../ACS/fbc">
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
    					<div class="form-group">
    						<label>Asset Sub Category</label>
    						<select name="assetSubCat" class="form-control" onchange="this.form.submit()">
    						<%if(request.getAttribute("assetSubCatList") != null){ %>
    						<%if(request.getAttribute("subCat") == null){ %>
    						<option selected value ="">Select one subCategory</option>
    						<%} %>
    					...
    					<div class="from-group">
    						...
    						<input value="<%out.println(request.getAttribute("rc")); %>" readonly type="text" name="receivingCode" class="form-control"/>
    						<%}else if(request.getAttribute("stockObj") != null){%>
    						<input value="<c:out value="${stockObj.recievingCode }"/>" readonly type="text" name="receivingCode" class="form-control"/>
    						<%}else{ %>
    					    <input value="tobeloaded" readonly type="text" name="receivingCode" class="form-control"/>
    						
    						<%} %>
    					</div>
    					<div class="form-group">
    					<br>
    						<input  value="populate"  class="" type="submit" class="form-control" id = "assetClass" />
    						</div>
                  </div>
                  <div class="tab-pane fade" id="custom-tabs-two-messages" role="tabpanel" aria-labelledby="custom-tabs-two-messages-tab">
				  		...
				  		<div class="col-md-4">
					  		<div  id="itA"  class="form-group">
	    						...
	    						<input readonly value="<%out.println(request.getAttribute("sysGenTag"));%>" id="tag"  name="tag" type="text" class="form-control" id = "assetClass" required>
	    						</div>
	    					<div id="itd"  class="form-group">
	    						<label for="some">list serials.</label>
	    						<select name="serialnos" class="form-control">
	    						 <option></option>
	    						</select>
	    						</div>
				  		...
				  		<div class="col-md-4" id="xx">
					  		<div id="itC"  class="form-group">
	    						<label for="some">Serial Or Chassis No.</label>
	    						<input readonly value="<%out.println(request.getAttribute("serialNo")); %>" id="plate"  name="serial" type="text" class="form-control" id = "assetClass" >
	    						</div>
