   ...
   // System.out.println("sending request to asset controller...");
    RequestDispatcher ds = request.getRequestDispatcher("../BCS");
    ...
    <div class="row">
     ...
     <div class="invoice p-3 mb-3">
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <td><c:out value="${voucher.assetSpec}"></c:out></td>
                    </tr>
                   </c:forEach>
                   <tr>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="../BCS/print?issueref=<%out.println(request.getAttribute("issueref"));%>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                </div>
              </div>
            </div>
    </section>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
             <form action = "../BCS/search" method = "POST">
               <div class ="row">
            	<div class="col-md-3">
            	 <div class="form-group">
